...
func setup_boar(context_enemy: Boar, context_animation: AnimationPlayer, context_boar_wall_checker: RayCast2D, context_boar_floor_checker: RayCast2D, context_boar_player_checker: RayCast2D, context_boar_) -> void:
	enemy = context_enemy
